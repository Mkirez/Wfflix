...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-xs-12 col-md-12 col-sm-12 col-lg-12 text-left videos-courses">
 ...
 -->       
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12 col-md-12 text-left card-text">
                                        <h2 class="card-title">full course html & css</h2>
                                        <p>Lorem Ipsum Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus.</p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-left videos-courses">
                <div class="course-text">
                    <h1>php</h1>
                </div>
                <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-left card-text">
                                        <h2 class="card-title">intro php course</h2>
                                        <p>Lorem Ipsum Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12 col-xs-12 col-md-4">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-left card-text">
                                        <h2 class="card-title">php basic syntax</h2>
                                        <p>Lorem Ipsum Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-left card-text">
                                        <h2 class="card-title">include files in php</h2>
                                        <p>Lorem Ipsum Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-left card-text">
                                        <h2 class="card-title">datatypes</h2>
                                        <p>Lorem Ipsum Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus.</p>
                                    </div>
                                </div>
                            </div>
