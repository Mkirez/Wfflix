        ...
        <div class="row">
            <div class="col-md-12">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/edlFjlzxkSI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="row">
                    <div class="col-md-6 text-left ">
                        <div class="col controls-right">   <!--Next video-->
                            <a href="/jsfundamentals" id="next_link">&lt;-  vorige video</a>                        
                        </div>
                    </div>
                    <div class="col-md-6 text-right">
                        <div class="col controls-right">   <!--Next video-->
                            <a href="jsdatatypes">Next video -&gt;</a>
                        </div>
                    </div>
