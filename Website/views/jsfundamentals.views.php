        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 text-left text-white">
                    <h1>01 javascript fundamentals></h1>
                </div>
            </div>
    </div>
    <div class="space">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/vEROU2XtPR8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <div class="col controls-right">   <!--Next video-->
                            <a href="/jsvariables">volgende video -&gt;</a>
                        </div>
                    </div>
